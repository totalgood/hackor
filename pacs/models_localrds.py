...
#     filer_id = models.FloatField(primary_key=True)
...
# class CandidateSumByDates(models.Model):
#     created_at = models.DateTimeField()
#     updated_at = models.DateTimeField()
...
# class CcGrassRootsInStates(models.Model):
#     created_at = models.DateTimeField()
#     updated_at = models.DateTimeField()
...
#     maling_address = models.LongCharField(max_length=-1, blank=True, null=True)
...
#     committee_id = models.IntegerField(db_column='committee_id', blank=True, null=True)
