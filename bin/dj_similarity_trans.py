...
for fid in filer_id:
    trans = df[df.filer_id == fid]['contributor_payee_committee_id'].values.asarray()
    break
    # tf[trans['filer_id']].update(trans[contributor_payee_committee_id])
...
def transaction_matrix(table=WorkingTransactions):
    pass
